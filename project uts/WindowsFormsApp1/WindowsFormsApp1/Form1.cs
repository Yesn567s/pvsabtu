...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void upgset() // knee grow
        {
            ...
            GlobalData.upg.clay.AddclayRow(3, 225, 110, 225, 140, 1080, 21, 8);
            GlobalData.upg.clay.AddclayRow(4, 375, 185, 375, 235, 1930, 31, 10);
            GlobalData.upg.clay.AddclayRow(5, 620, 310, 620, 390, 3290, 46, 15);
            GlobalData.upg.clay.AddclayRow(6, 1040, 520, 1040, 650, 5470, 70, 24);
            GlobalData.upg.clay.AddclayRow(7, 1735, 870, 1735, 1085, 8950, 98, 28);
            GlobalData.upg.clay.AddclayRow(8, 2900, 1450, 2900, 1810, 14520, 140, 42);
            GlobalData.upg.clay.AddclayRow(9, 4840, 2420, 4840, 3025, 23430, 203, 63);
            GlobalData.upg.clay.AddclayRow(10, 8080, 4040, 8080, 5050, 37690, 280, 77);
            GlobalData.upg.clay.AddclayRow(11, 13500, 6750, 13500, 8435, 60510, 392, 112);
            GlobalData.upg.clay.AddclayRow(12, 22540, 11270, 22540, 14090, 97010, 525, 133);
            GlobalData.upg.clay.AddclayRow(13, 37645, 18820, 37645, 23525, 155420, 693, 168);
            GlobalData.upg.clay.AddclayRow(14, 62865, 31430, 62865, 39290, 248870, 889, 196);
            GlobalData.upg.clay.AddclayRow(15, 104985, 52490, 104985, 65615, 398390, 1120, 231);
            GlobalData.upg.clay.AddclayRow(16, 175320, 87660, 175320, 109575, 637620, 1400, 280);
            GlobalData.upg.clay.AddclayRow(17, 292790, 146395, 292790, 182995, 1020390, 1820, 420);
            GlobalData.upg.clay.AddclayRow(18, 488955, 244480, 488955, 305600, 1632820, 2240, 420);
            GlobalData.upg.clay.AddclayRow(19, 816555, 408280, 816555, 510350, 2612710, 2800, 560);
            GlobalData.upg.clay.AddclayRow(20, 1363650, 681825, 1363650, 852280, 4180540, 3430, 630);

            GlobalData.upg.iron.AddironRow(1, 100, 80, 30, 60, 450, 7, 0);
            GlobalData.upg.iron.AddironRow(2, 165, 135, 50, 100, 920, 13, 6);
            GlobalData.upg.iron.AddironRow(3, 280, 225, 85, 165, 1670, 21, 8);
            GlobalData.upg.iron.AddironRow(4, 465, 375, 140, 280, 2880, 31, 10);
            GlobalData.upg.iron.AddironRow(5, 780, 620, 235, 465, 4800, 46, 15);
            GlobalData.upg.iron.AddironRow(6, 1300, 1040, 390, 780, 7880, 70, 24);
            GlobalData.upg.iron.AddironRow(7, 2170, 1735, 650, 1300, 12810, 98, 28);
            GlobalData.upg.iron.AddironRow(8, 3625, 2900, 1085, 2175, 20690, 140, 42);
            GlobalData.upg.iron.AddironRow(9, 6050, 4840, 1815, 3630, 33310, 203, 63);
            GlobalData.upg.iron.AddironRow(10, 10105, 8080, 3030, 6060, 53500, 280, 77);
            GlobalData.upg.iron.AddironRow(11, 16870, 13500, 5060, 10125, 85800, 392, 112);
            GlobalData.upg.iron.AddironRow(12, 28175, 22540, 8455, 16905, 137470, 525, 133);
            GlobalData.upg.iron.AddironRow(13, 47055, 37645, 14115, 28230, 220160, 693, 168);
            GlobalData.upg.iron.AddironRow(14, 78580, 62865, 23575, 47150, 352450, 889, 196);
            GlobalData.upg.iron.AddironRow(15, 131230, 104985, 39370, 78740, 564120, 1120, 231);
            GlobalData.upg.iron.AddironRow(16, 219155, 175320, 65745, 131490, 902790, 1400, 280);
            GlobalData.upg.iron.AddironRow(17, 365985, 292790, 109795, 219590, 1444660, 1820, 420);
            GlobalData.upg.iron.AddironRow(18, 611195, 488955, 183360, 366715, 2311660, 2240, 420);
            GlobalData.upg.iron.AddironRow(19, 1020695, 816555, 306210, 612420, 3698850, 2800, 560);
            GlobalData.upg.iron.AddironRow(20, 1704565, 1363650, 511370, 1022740, 5918370, 3430, 630);

            GlobalData.upg.wood.AddwoodRow(1, 40, 100, 50, 60, 260, 7, 0);
            GlobalData.upg.wood.AddwoodRow(2, 65, 165, 85, 100, 620, 13, 6);
            GlobalData.upg.wood.AddwoodRow(3, 110, 280, 140, 165, 1190, 21, 8);
            GlobalData.upg.wood.AddwoodRow(4, 185, 465, 235, 280, 2100, 31, 10);
            GlobalData.upg.wood.AddwoodRow(5, 310, 780, 390, 465, 3560, 46, 15);
            GlobalData.upg.wood.AddwoodRow(6, 520, 1300, 650, 780, 5890, 70, 24);
            GlobalData.upg.wood.AddwoodRow(7, 870, 2170, 1085, 1300, 9620, 98, 28);
            GlobalData.upg.wood.AddwoodRow(8, 1450, 3625, 1810, 2175, 15590, 140, 42);
            GlobalData.upg.wood.AddwoodRow(9, 2420, 6050, 3025, 3630, 25150, 203, 63);
            GlobalData.upg.wood.AddwoodRow(10, 4040, 10105, 5050, 6060, 40440, 280, 77);
            GlobalData.upg.wood.AddwoodRow(11, 6750, 16870, 8435, 10125, 64900, 392, 112);
            GlobalData.upg.wood.AddwoodRow(12, 11270, 28175, 14090, 16905, 104050, 525, 133);
            GlobalData.upg.wood.AddwoodRow(13, 18820, 47055, 23525, 28230, 166680, 693, 168);
            GlobalData.upg.wood.AddwoodRow(14, 31430, 78580, 39290, 47150, 266880, 889, 196);
            GlobalData.upg.wood.AddwoodRow(15, 52490, 131230, 65615, 78740, 427210, 1120, 231);
            GlobalData.upg.wood.AddwoodRow(16, 87660, 219155, 109575, 131490, 683730, 1400, 280);
            GlobalData.upg.wood.AddwoodRow(17, 146395, 365985, 182995, 219590, 1094170, 1820, 420);
